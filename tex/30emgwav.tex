...
\section{O vetor de Poynting e a irradiância}\label{sec:irradiance}
...
\begin{figure}[htb]
  {\centering
    \begin{tikzpicture}
      ...
      \node at ( -1.69,0) {UV};
      \draw [dashed] (-0.39794,-0.5) --+(0,1);
      \draw [dashed] (-0.15490,-0.5) --+(0,1);
      \node at (0.93,0) {IV};
...
\subsection{Emissão e absorsão de radiação}
...
\subsection{Dispersão de radiação}
