...
comportamento e propriedades das funções de onda com forma sinusoidal, pois
qualquer outra função de onda pode ser construida com sobreposições dessas
funções.
...
\begin{equation}\label{eq:hwav}
    \psi(x,t)=A\cos\left(\frac{2\pi}{\lambda}\left[x-v_xt\right]+
            \phi_0\right)
\end{equation}
Nesta equação $x$ e $t$ representam, respetivamente, a posição e o tempo. 
