    ...
    \begin{tikzpicture}
      ...
      \foreach \n [count=\i from 0] in {2,3,4,5,10,15} {
        ...
        \begin{scope}[shift={(\x*3.5,-\y*2)}]
          ...
          \draw [thin, domain=-1.3:1.3, variable=\x,smooth, samples=252]
            plot (\x,
...
%faixas números $\pm m$, com $m=(N-1)/2$ .
%\begin{figure}[htb]
%{\centering
...
%  \end{tikzpicture}\par
%  }
%  \caption{Parte de uma rede de difração iluminada por luz
...
%  sobreposição das ondas provenientes de cada faixa. (O desenho não está à
